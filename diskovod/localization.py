...
UI_TEXT: dict[str, dict[str, str]] = {
    ...
    "web_search_probe_unavailable": {
        "en": "The selected subscription model did not complete the hosted search test",
        "ru": "Выбранная модель подписки не прошла проверку встроенного веб-поиска",
        "uk": "Вибрана модель підписки не пройшла перевірку вбудованого вебпошуку",
        "ja": "選択したサブスクリプションモデルはホスト型検索テストを完了できませんでした",
        "zh": "所选订阅模型未能完成托管搜索测试",
        "de": "Das ausgewählte Abonnementmodell hat den Test der gehosteten Suche nicht abgeschlossen",
        "fr": "Le modèle d’abonnement sélectionné n’a pas terminé le test de recherche hébergée",
    },
